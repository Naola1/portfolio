      ...
      <main className="relative">
        ...
        <section className="min-h-screen flex items-center justify-center px-4">
          ...
          >
            ...
            <p className="text-lg text-cyan-300 max-w-2xl mx-auto">
              Passionate about creating efficient, scalable solutions that bridge technology and business needs. 
          ...
          >
            <Card className="p-8 bg-black/50 backdrop-blur border border-cyan-500/20">
              ...
              <p className="text-cyan-300 leading-relaxed">
                ...
                Specialized in backend development with expertise in system engineering and DevOps practices. 
              ...
              <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="p-4 bg-cyan-500/10 rounded-lg">
                  ...
                  <p className="text-cyan-300">Full Stack Development Program</p>
                  <p className="text-cyan-400">2023 - 2024</p>
                </div>
                <div className="p-4 bg-cyan-500/10 rounded-lg">
                  <h3 className="text-white font-semibold mb-2">Focus Areas</h3>
                  <p className="text-cyan-300">Backend Development</p>
                  <p className="text-cyan-300">System Architecture</p>
                </div>
              </div>
            </Card>
          </motion.div>
        ...
        <section className="py-20 px-4">
          <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              { icon: Code, title: 'Frontend', skills: ['React', 'TypeScript', 'JavaScript', 'Tailwind CSS', 'HTML5'] },
              { icon: Terminal, title: 'Backend', skills: ['Django', 'Python', 'REST'] },
              { icon: Database, title: 'DevOps', skills: ['PostgreSQL', 'SQL', 'Docker', 'Git'] }
            ].map((category, index) => (
              <motion.div
                key={category.title}
              ...
              {[
                {
                  ...
                  tech: ['Django', 'PostgreSQL', 'Tailwind CSS', 'HTML5'],
                ...
                },
                {
                  ...
                  tech: ['React', 'TypeScript', 'Django REST', 'HTML5'],
